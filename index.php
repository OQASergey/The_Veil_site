...
<div class="container">
	<div class="row title">
		<div class="col-12">
			...
			<div class="att-text">
				<br>
<p id="at2" style="color: #fff; font-size: 20px;">Данный сайт является небольшим справочным ресурсом для личного использования по настольной ролевой игре the Veil (авторы: Фрейзер и Кайл Симмонс). Сайт ничего не пропогандирует и не распространяет. На сайте находятся только игровые буклеты и демонстрационные материалы. Для ознакомления с полной версией книги обращайтесь на официальную страницу настолько ролевой игры "The Veil".</p>
			</div>
